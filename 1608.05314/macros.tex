...
\newcommand{\icomma}[1]{\mathbin{\mathop{\itimes}_{#1}}}
...
\newcommand{\bitimes}{\mathbin{\tilde{\mathord\times}}}
...
\newcommand{\pbudiamond}{\save[]+<0pt,5pt>*{\rotatebox{135}{$\pbcorner$}}\restore}
\newcommand{\wpbexcursion}{\save[]+<5pt,-5pt>*{\pbcorner}+<7pt,-7pt>*{\labelstyle\simeq}\restore}
...
\def\parsedel@@@{%
  \ifx\space@\del@next \expandafter\del@dn\space{\del@fn\parsedel@@@}%
  \else\ifx t\del@next \del@dn t{\Del@Sym_{\top}\del@fn\parsedel@@@@}%
  \else\ifx b\del@next \del@dn b{\Del@Sym_{\bot}\del@fn\parsedel@@@@}%
...
\newcommand{\Segal}{\category{Segal}}
\newcommand{\CSS}{\category{CSS}}
\newcommand{\mqCat}{\category{qCat}^\natural}
...
\newcommand{\qcoCart}{\category{qcoCart}}
...
\newcommand{\isoSpan}[2]{\category{Span}_{\tcat{C}}(#1,#2)}
\newcommand{\SSpan}[1]{\category{Span}_{\lcat{#1}}}
\newcommand{\Mod}[2]{{}\category{Mod}_{\lcat{K}}(#1,#2)}
\newcommand{\MMod}[1]{\category{Mod}_{\lcat{#1}}}
\newcommand{\qMod}[2]{\mathrm{mod}(#1,#2)}
\newcommand{\dmod}[3]{\xymatrix@=1.25em{{#2} \ar[r]|\mid^{ {#1}} & {#3}}}
...
\newcommand{\TwAr}[1]{\mathrm{TwAr}(#1)} %for twisted arrow quasi-categories (note conflict with \twar)
...
%for left and right closures in an equipment
\newcommand{\lhom}{\underline{\hom}^\ell}
\newcommand{\rhom}{\underline{\hom}^r}
...
\newcommand{\longtwoheadrightarrow}{\mathrel{\mathord{-}\mkern-3mu\mathord\twoheadrightarrow}}
...
\newcommand{\trvfib}{\stackrel{\smash{\mkern-2mu\mathlower{1.5}{\sim}}}\longtwoheadrightarrow}
...
\newcommand{\iTo}{\mathbin{\stackrel{\smash{\mkern-5mu\mathlower{.25}{\sim}}}\Rightarrow}}
