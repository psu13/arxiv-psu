...
\ba
<m_f|T^1|m_i> & = &  -\frac{1}{2} \int^{t_f}_{t_0} dt 
<m_f|U_0(t_f,t) \left( \frac{\partial}{\partial \vec{r}_0} 
\right)_{\vec{p}_0} 
\left( \frac{\partial V(t)}{\partial\vec{p}_0} \right)_{\vec{r}_f} 
{U}_0(t,t_0)|m_i>  \label{t1} \\
<m_f|T'|m_i>& = & \frac{i}{2 \hbar} \int^{t_f}_{t_0} dt \int_{t_0}^t dt'
<m_f|{U}_0(t_f,t) \left[ \left (\frac{ \partial V(t)}{ \partial \vec{p}_0} 
...
\right)_{\vec{r}_0}\right] U_0(t',t_0) |m_i>  \label{t'}
\ea
...
\ba
<m_f|T'|m_i> = \left( \mu_0 B_1 \right)^2 \frac{i}{2 \hbar M} 
\int^{t_f}_{t_0} dt
\int^{t}_{t_0}dt'(t - t') & 
<m_f |\left[ U_0(t_f,t) I_x  U_0(t,t') 
I_x U_0(t', t_0) \right. \nonumber \\ 
& \left.  +  U_0(t_f,t)I_z U_0(t,t') 
I_z U_0(t',t_0) \right] |m_i> 
\ea
...
\int^{t_f}_{t_0} dt
\int^{t}_{t_0}dt'(t - t') & 
 <m_f |\left[ U_0(t_f,t) I'_x U_0(t,t') 
I'_x U_0(t',t_0) \right. \nonumber \\
 &   \left. + U_0(t_f,t) I'_z U_0(t,t') 
I'_z U_0(t',t_0) \right] |m_i> 
\ea
...
\left( \mu_0 B_1 \right)^2 \frac{i}{2 \hbar M} \int^{t_f}_{t_0} dt
 \int^{t}_{t_0}dt' (t-t')    
&  <m'_i | \left[U_0(t_0,t){I'}_x U_0(t,t')
{I'}_x \hat{U}_0(t',t_0) +   \right. \nonumber \\  
 &   \left. U_0(t_0,t) {I'}_z U_0(t,t')
 {I'}_z U_0(t',t_0) \right] |m_i> + h.c.
\label{del}
\ea
...
This result shows that the states $|m_i>$, with a definite spin projection 
...
< m(t)| \frac{ \partial}{ \partial \vec{r}}
(\vec{ \mu} \cdot \vec{B}(\vec r)) |_{\vec r = \vec r_m(t)} | m(t)>
 \label{cla}
\ea
...
\be 
<m(t)|\frac{ \partial}{ \partial \vec{r}} (\vec{ \mu} \cdot \vec{B}(\vec r))
|m(t)> 
...
\be
<p_e({m})> =\left({I(I+1)-{m}^2 \over 2}\right) {a^2 B_1^2 
                       \over 2 B_0^2}
\ee
