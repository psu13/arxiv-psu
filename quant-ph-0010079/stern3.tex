...
$\vec r(t)$.
In this expression, $| m \rangle$ is one of the CIS, and $|m(f)>$ is the final
state, defined by
\be
|m(f)> = U_B(\vec r_m(t);t_f,t_0) | m \rangle 
\ee
...
$|m(t)> = U_B(\vec r_m(t);t,t_0) | m \rangle$. These  equations describe 
the motion of a classical particle with a magnetic moment $\vec \mu(t)
= \langle m(t)|\vec \mu|m(t)>$ moving in the inhomogeneous magnetic field 
...
|m(t)> 
=  - \mu_0 B_1(\langle m(t)|I_z|m(t)> \hat u_z - \langle m(t)|I_x|m(t)>  \hat u_x)
\ee
...
\be
\langle m(t)|I_z|m(t)> = \cos(\beta(x_0,z_0)) \quad ; \quad \langle m(t)|I_x|m(t)>
 =  \sin(\beta(x_0,z_0)) 
\ee
...
$|m' \rangle$. The probability that the state $|m;L>$ follows the trajectory of 
$|m' \rangle$ is simply  
\be
