...
\documentclass[12pt,english,vecarrow]{extarticle}
...
\par\end{centering}
\caption{\label{fig:The-mobius-strip}The \textbf{M\"obius strip}\index{M\"obius strip}
(AKA M\"obius band\index{M\"obius band}) has a base space which is a
