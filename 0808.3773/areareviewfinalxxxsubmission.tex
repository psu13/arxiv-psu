\documentclass[rmp,twocolumn,floatfix,epsfig,graphics]{revtex4} % showpacs
%\documentclass[twocolumn,floatfix,epsfig,graphics]{revtex4} % showpacs

\usepackage{amsmath,amsfonts,amssymb,graphics,graphicx,epsfig,times,color,bbm,fancybox}
