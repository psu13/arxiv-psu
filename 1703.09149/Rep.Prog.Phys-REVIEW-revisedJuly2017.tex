...
\affiliation{
Centre de Physique Th\'eorique,   Aix Marseille Université, Université de Toulon, CNRS, UMR 7332, 13288 Marseille, France.
}
\begin{abstract}
...
\delta M=\underbrace{\frac{\kappa}{8\pi} \delta a }_{heat?}+\Omega \delta J+\Phi  \delta Q,
\end{eqnarray}
%
...
is made of fundamental building blocks called photons. {\bf Similarly, in the present context, equation (\ref{1st}) is a clear physical indication that the smooth spacetime geometry    
...
\begin{array}{c}
\includegraphics[height=12cm]{BH-holo} 
...
\ba\label{actiong}
S[e_a^A,\omega_a^{AB}]&=&\frac{1}{2 \kappa} \int \overbrace{ \epsilon_{IJKL} e^I\wedge e^J\wedge F^{KL}(\omega)}^{\rm Einstein}+\overbrace{{\Lambda} \, \epsilon_{IJKL} e^I\wedge e^J\wedge e^K\wedge e^L }^{\rm Cosmological\, Constant}+\overbrace{\alpha_1 \ e_I\wedge e_J\wedge F^{IJ}(\omega)}^{\rm Holst} \\\n  &+&\underbrace{\alpha_2 \ (d_{\omega} e^I \wedge d_{\omega} e_I \,- \ e_I\wedge e_J\wedge F^{IJ}(\omega))}_{\rm Nieh-Yan}  + \underbrace{\alpha_3 \ F(\omega)_{IJ} \wedge F^{IJ}(\omega)}_{\rm Pontrjagin}  +\underbrace{\alpha_4 \ \epsilon_{IJKL} F(\omega)^ {IJ} \wedge F^{KL}(\omega)}_{\rm Euler}, 
\ea 
...
\ba\label{sympotg}
\Theta(\delta)&=&\frac{1}{\kappa} \int_{\Sigma}\left( \epsilon_{0jkl}  e^0\wedge e^j\wedge \delta \omega^{kl}+ \frac{1}{\gamma} e^0\wedge e^i  \wedge \delta \omega_{0i}\right)-\frac{1}{\kappa} \int_{\Sigma}\left( \epsilon_{0jkl}  e^j\wedge e^k \wedge \delta \omega^{l0} +\frac{1}{\gamma} e^i\wedge e^j  \wedge \delta \omega_{ij}\right) \n \\ &=& 
...
\ee
which can be inverted to give $\omega^{ij}(e)\equiv \epsilon^{ijk}\omega_{k}(e)$. Now in three dimensions only, and in  terms of this definition, we can write the Cartan equation (\ref{ce}) as
\be\label{ce}
...
\ee
using (\ref{ce}) to rewrite the third term, and renaming dummy indices, one gets a key result for the foundations of LQG, namely that 
\be \label{niuns}
...
\includegraphics[height=8cm]{TetraHedron} 
...
\centerline{\hspace{0.5cm} \(
\begin{array}{c}
\includegraphics[height=12cm]{BH-holo-quantum-w-cc} 
...
\centerline{\hspace{0.5cm} \(
\begin{array}{c}
\includegraphics[height=12cm]{BH-holo-quantum-w} 
\end{array}\ \ \ \begin{array}{c}
\includegraphics[height=12cm]{BH-holo-quantum} 
...
\centerline{\hspace{0.5cm} \(
\begin{array}{c}
\includegraphics[height=8cm]{BH-firewall} 
...
\centerline{\hspace{0.5cm} \(
\begin{array}{c}
\includegraphics[height=12cm]{BH-holo-quantum-info} 
...
Aurélien Barrau, Boris Bolliet, Francesca Vidotto, and Celine Weimer.
...
Aurélien Barrau and Carlo Rovelli.
...
Ernesto Frodden, Alejandro Perez, Daniele Pranzetti, and Christian Röken.
