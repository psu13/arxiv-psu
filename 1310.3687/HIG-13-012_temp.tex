...
\centering
    ...
    \label{fig:BDT_norm}
\end{figure*}
\cleardoublepage \appendix\section{The CMS Collaboration \label{app:collab}}\begin{sloppypar}\hyphenpenalty=5000\widowpenalty=500\clubpenalty=5000\input{HIG-13-012-authorlist.tex}\end{sloppypar}
\end{document}
