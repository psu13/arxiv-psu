...
\def\weglaten#1{}		\def\ul#1{\underline{#1\vphantom{p}}}
...
\be \ds u^\pm(\W) =  \sum_{\ell,m}u_{\ell m}Y_{\ell m}(\W)\ , \  &&\spc  p^\pm(\W) =\ \sum_{\ell,m}
 ...
 \ds  u^-_{\ell m,\,\outt} = \frac{8\pi G}{\ell^2+\ell+1}\,p^-_{\ell m,\,\inn}\ , &&\ \spc   u^+_{\ell m,\,\inn}
