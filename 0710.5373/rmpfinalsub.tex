...
\documentclass[floatfix,twocolumn,aps,rmp,showpacs,amsmath,amssymb,eqsecnum]{revtex4}
...
\left[ \hat{a}_{\omega{\bf k}_\perp}^R
...
\nonumber \\
&& \times \left[ 
\alpha_{\omega k_z k_\bot}^R e^{-i(k_0 -k_z)V/2} + \right.\nonumber \\
&& \left. + \beta_{\omega k_z k_\bot}^R e^{i(k_0-k_z)V/2}\right]
\frac{e^{i{\bf k}_\bot\cdot{\bf x}_\bot}}{2\pi}.
\end{eqnarray}
...
\hat{\Phi}(x')|0_{\rm M}\rangle\nonumber \\
& = & \int \frac{dk_z d^2{\bf k}_\bot}{2k_0(2\pi)^3}
...
\left\{ \left[ v^R_{\omega{\bf k}_\bot}(x)v^{R*}_{\omega{\bf
k}_\bot}(x') + v^L_{\omega{\bf k}_\bot}(x)v^{L*}_{\omega{\bf
k}_\bot}(x')\right]
(1-e^{-2\pi\omega/a})^{-1}\right.\nonumber \\
&& \ \ \ \ \ \ \ \ \ \ +  \left[ v^{R*}_{\omega{\bf k}_\bot}(x)
v^R_{\omega{\bf
k}_\bot}(x') + v^{L*}_{\omega{\bf k}_\bot}(x)v^L_{\omega{\bf
k}_\bot}(x')\right]
(e^{2\pi\omega/a}-1)^{-1}\nonumber \\
&& \ \ \ \ \ \ \ \ \ \ 
+ 2\left[ v^R_{\omega{\bf k}_\bot}(x)v_{\omega\,-{\bf k}_\bot}^L(x^{\prime})
+ v^{R*}_{\omega{\bf k}_\bot}(x)v^{L*}_{\omega\,-{\bf k}_\bot}(x^{\prime})\right] 
(e^{\pi\omega/a}-e^{-\pi\omega/a})\nonumber \\
&& \ \ \ \ \ \ \ \ \ \ \left.
+ 2\left[ v^L_{\omega{\bf k}_\bot}(x)
v_{\omega\,-{\bf k}_\bot}^R(x^{\prime})
+ v^{L*}_{\omega{\bf k}_\bot}(x)
v^{R*}_{\omega\,-{\bf k}_\bot}(x^{\prime})\right] 
(e^{\pi\omega/a}-e^{-\pi\omega/a})\right\}.
\end{eqnarray}
...
\Delta(x;x^{\prime})
 = \int_0^\infty d\omega \int d^2{\bf k}_\bot
\left[ w_{+\omega{\bf k}_\bot}(x)w^*_{+\omega{\bf k}_\bot}(x^{\prime})
+ w_{-\omega{\bf k}_\bot}(x)w^*_{-\omega{\bf
k}_\bot}(x^{\prime})\right],
...
\hat{g}^{R}(-\omega,{\bf k}_\bot)\right. \nonumber \\
&& \left. + \hat{f}^{R*}(+\omega,{\bf k}_\bot)
\hat{g}^{R}(+\omega,{\bf k}_\bot)\right],
\end{eqnarray}
...
& = & 
\frac{e^{i{\bf k}_\bot\cdot{\bf x}_\bot \pm i\omega\zeta}}{2\pi}
\int_{-\infty}^\infty \frac{d\vartheta}{\sqrt{8a}\,\pi}
e^{\pm i \omega \vartheta/a} \nonumber \\
&& \ \ \ \ \ \ \ \ \ \ 
\times \exp\left( - i\kappa T\cosh\vartheta \right).
\end{eqnarray}
...
x}_\bot}\nonumber \\
&& \times e^{i(k_0t-k_z z)\cosh\alpha a}
...
\begin{figure}
\begin{center}
\mbox{\epsfig{file=crispinoetal_fig07.ps,width=0.45\textwidth,angle=0}}
\end{center}
...
\begin{figure}
\begin{center}
\mbox{\epsfig{file=crispinoetal_fig08.ps,width=0.45\textwidth,angle=0}}
\end{center}
...
\begin{eqnarray}
R_{\rm LS}  & = & |q|^2\left\{ - \frac{\Delta E}{4\pi} +
 \frac{1}{2\pi^2}\int_0^{\tau-\tau_0}ds
...
\begin{figure}
\begin{center}
\mbox{\epsfig{file=crispinoetal_fig03.ps,width=0.45 \textwidth,angle=0}}
\end{center}
\caption{ 
...
&& = 
\frac{ q^2 }{4 \pi^3 a} \sinh (\pi E/a) \delta(E-\omega)
\nonumber \\
&& \ \ \ \ \times 
...
\begin{figure}
\begin{center}
\mbox{\epsfig{file=crispinoetal_fig10.ps,width=0.45\textwidth,angle=0}}
\end{center}
