...
\documentclass[11pt,prd,onecolumn,aps,floats,superscriptaddress,floatfix,nofootinbib]{revtex4-2}
\usepackage{url}
\usepackage{graphicx}
...
\usepackage[papersize={7.0in, 10.0in}, left=.5in, right=.5in, top=.5in, bottom=.9in]{geometry}
\linespread{1.05}
\sloppy
\raggedbottom
\pagestyle{plain}
...
\begin{figure}
\centering
\includegraphics[scale=0.4]{higgs_1.eps}
\hspace{1.truecm}
\includegraphics[scale=0.4]{higgs_2.eps}
...
{{ $=-3i\frac{M_H^2}{v}$}\vspace{0.75truecm}}
\end{minipage}&
\begin{minipage}{0.5\linewidth}
\includegraphics[scale=0.6]{4H_coupling}\parbox[b]{4.truecm}
{{ $=-3i\frac{M_H^2}{v^2}$}\vspace{0.75truecm}}
\end{minipage}
\end{tabular}
\vspace{0.5truecm}
...
\begin{figure}
\centering
\includegraphics[bb=125pt 470pt 490pt 760pt,scale=0.7]{GHgg-2loop.eps}
\vspace{0.3truecm}
