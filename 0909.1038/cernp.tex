...
\be
\rho_{(c_{n+1}, b_{n+1})}=\pmatrix { \langle \Lambda^{(1)}|\Lambda^{(1)}\rangle & \langle \Lambda^{(1)}|\Lambda^{(2)}\rangle\cr \langle \Lambda^{(2)}|\Lambda^{(1)}\rangle&\langle \Lambda^{(2)}|\Lambda^{(2)}\rangle\cr }
\label{density}
\ee
...
\be
|\Psi_{M,c}, \psi_b(t_{n+1})\rangle=\Big[|0\rangle_{c_{n+1}}|0\rangle_{b_{n+1}}\sqi(\Lambda^{(1)}+\Lambda^{(2)})\Big ]+ \Big [|1\rangle_{c_{n+1}} |1\rangle_{b_{n+1}}\sqi(\Lambda^{(1)}-\Lambda^{(2)})\Big ]
\ee
The density matrix describing $c_{n+1}$ is
\be
\rho_{c_{n+1}}=\pmatrix{ \h\langle (\Lambda^{(1)}+\Lambda^{(2)})|(\Lambda^{(1)}+\Lambda^{(2)})\rangle & 
0\cr 0& \h\langle (\Lambda^{(1)}-\Lambda^{(2)})|(\Lambda^{(1)}-\Lambda^{(2)})\rangle\cr}
\ee
Using $\langle\Lambda^{(2)}|\Lambda^{(2)}\rangle= \epsilon_2^2$, $\langle\Lambda^{(1)}|\Lambda^{(1)}\rangle=1-\epsilon_2^2$,  we get
\be
\rho_{c_{n+1}}=\h I+\pmatrix{ Re\langle\Lambda^{(1)}|\Lambda^{(2)}\rangle&0\cr 0&-Re\langle\Lambda^{(1)}|\Lambda^{(2)}\rangle\cr}+O(\epsilon^2)
\ee
and
\be
