...
\textwidth= 16,5cm \textheight= 24,5cm \hoffset=-2,2cm
\voffset=-1,5cm
...
\markright{\sc A. Echeverr\'ia {\it et al\/},
   \sl Mathematical foundations of geometric quantization.}
...
following an appropriate procedure, which is called {\sl quantization}
of the system.
...
\begin{itemize}
\item
{\sl Classical description} (starting data).
...
a new theory, called {\sl geometric quantization}, was developed in the
70's.
...
Nowadays, their results constitute what is known as {\sl prequantization
...
The key is to introduce the {\sl bundles of densities and half-forms}
\cite{Wn-77}
in order to define the inner product between quantum states.
Finally, in many cases, the so-called {\sl metaplectic correction} must
be done
...
it was applied soon to {\sl presymplectic manifolds},
as an attempt for giving a geometric framework for the canonical
quantization
rules which P.A.M. Dirac applied to {\sl singular systems}
...
{\sl BRST quantization} (from {\it Becchi-Rouet-Stora-Tuytin})
...
applied to
{\sl Poisson manifolds} \cite{Va-91}, \cite{Va-97}.
...
of
{\sl Jacobi manifolds}  has been also considered recently \cite{CLM-96},
...
{\sl Batalin-Vilkovisky algebras}.
...
those which we can call the {\sl ``kinematical'' postulates},
the {\sl``dynamical'' postulate} and the {\sl ``statistical''
postulates}.
...
and the {\it projective Hilbert space formulation}
\footnote{
...
$\sta$ and $\lambda\sta$, so they must represent the same quantum state
\footnote{
...
a
{\sl separable (complex) Hilbert space} $\H$.
Every state of this system at time $t$ is represented by a
{\sl ray} $|\psi (t) \rangle_{\Complex}$ belonging to the Hilbert space.
...
{\sl self-adjoint linear operator} which acts on its associated Hilbert
space
\footnote{
...
{\sl Hamiltonian operator} of the system. Then:
\begin{enumerate}
\item
...
make up a
complete set of classical observables for $(M,\Omega )$
\footnote{
...
{\sl can every classical symmetry of a physical system
...
{\sl if $(M,\Omega )$ represents the classical phase space of a physical
...
{\sl quantum anomalies} in the physical literature
...
{\sl (Symplectic manifolds $(M,\Omega )$,  smooth real functions
$\Cinfty (M)$)}
and {\sl (Complex Hilbert spaces $\H$, self-adjoint operators ${\cal
O}(\H )$)};
or, in a more general way, a functor between the categories
{\sl (Symplectic manifolds $(M,\Omega )$, symplectomorphisms ${\bf
Sp}(M,\Omega )$)}
and {\sl (Complex Hilbert spaces $\H$, unitary operators ${\bf U}(\H
)$)}.
...
\label{depen}
\end{prop}
{\sl (Proof)} \quad If $s$ has null germ in $m$, then it vanishes
...
a {\sl hermitian metric} $\h_m$ on $L_m$, for every $m \in M$,
...
where $\LF$ is the {\sl Liouville's volume form}
...
\footnote{
Observe that $\C (M)$ coincides with the set of
...
is an {\sl integral cohomology class}
\footnote{
...
This is the
{\sl prequantization procedure} of Kostant, Souriau and Segal
...
\footnote{
Sometimes, this structure is called {\it Planck's foliation}
\cite{AM-78}.
}.
...
(those which we will call {\sl K\"ahler polarizations}),
...
and it is called the {\sl isotropic distribution}.
...
({\sl Nirenberg-Newlander theorem}
...
=\Omega_m (Y_m+\bar Y'_m,W_m+\bar W'_m) = \Omega_m (X_m,Z_m)
\eeann
...
follows that, for each $k$, $$ \left[ \int_K \h (\psi -\psi ',\psi
- \psi ') \LF \right]^{\frac{1}{2}} \leq \left[ \int_K \h (\psi
-\psi_k,\psi - \psi_k) \LF \right]^{\frac{1}{2}} +\left[ (2\pi
\hbar )^n\langle \psi ' - \psi_k \mid \psi ' - \psi_k \rangle
\right]^{\frac{1}{2}} $$ Taking into account the above mentioned
...
\left[\matrix{
B^1 \cr B^2 \cr \vdots \cr B^{n-l} \cr C^1 \cr \vdots \cr C^l}\right]
= \left[\matrix{0 \cr \vdots \cr 0 \cr}\right]
$$
...
the so-called {\sl metaplectic correction}
...
the {\sl bundles of densities and half-forms}, as new geometrical
structures
for quantization.
...
\in \Zahl \right\} $$ Observe that, if $h_1,h_2$ have the same
...
h=0,1 \ ; \ k \in \Zahl \right\} = \left\{ \overline{(0,I)},
\overline{\left(\frac{2\pi i}{n},e^{-\frac{2\pi i}{n}}I\right)}
\right\} \simeq \Zahl_2 $$ Therefore, we have the exact sequence
...
{\sl First case \/}: \underline{Trivial metalinear bundle}.
...
{\sl Second case \/}: \underline{ Non trivial metalinear bundle}.
...
general, by applying the {\sl coisotropic imbedding theorem}
...
{\sl reducing} (or {\sl constraining}) and {\sl quantizing};
...
{\sl Physica A} {\bf 139} (1986) 101-124.

\bibitem{Be-rglr}
{\sc P. Bernat} {\it et al.},
{\sl Representations des groupes de Lie resolubles},
Dunod, Paris, 1972.
...
on {\sl G\'eometri\'e symplectique et physique math\'ematique},
Coll. Int. C.N.R.S. {\bf 237}, Paris, (1975) 175-186

\bibitem{Bl-77}
{\sc R.J. Blattner},
``The metalinear geometry of non-real polarizations'',
in {\sl Differential geometrical methods in mathematical physics}
...
{\sl Mod. Phys. Lett.} {\bf 205}(4) (1988) 525-529.

\bibitem{Blau-88b}
{\sc M. Blau},
``On the geometric Quantisation of Constrained Systems'',
{\sl Class. Quant. Grav.} {\bf 5}(7) (1988) 1033-1044.
...
{\sl J. Phys. A: Math. Gen.} {\bf 29}(19) (1996) 6313-6324.

\bibitem{CDL-77}
{\sc C. Cohen-Tannoudji, B Diu, F. Lalo\"e},
{\sl M\'ecanique quantique},
Hermann, Paris, 1977.

\bibitem{Dd-ea}
{\sc J. Dieudonn\'e},
{\sl \'Elements d'Analyse},
vol 2, Gauthier-Villars, Paris, 1970.

\bibitem{Di-pqm}
{\sc P.A.M. Dirac},
{\sl The Principles of Quantum Mechanics},
Oxford Univ. Press, New York, 1930.

\bibitem{Di-rmp}
{\sc P.A.M. Dirac},
``Forms of Relativistic Dynamics'',
{\sl Rev. Mod. Phys.} {\bf 21} (1949) 392-399.
...
{\sl Ann. Phys.} {\bf 206}(1) (1991) 1-26.

\bibitem{DET-90}
{\sc C. Duval, J. Elhadad, G.M. Tuynman},
``The BRST Method and Geometric Quantization'',
{\sl Comm. Math. Phys.} {\bf 126}(3) (1990) 535-557.

\bibitem{GP-78}
{\sc A. Galindo, P. Pascual},
{\sl Mec\'anica Cu\'antica\/},
Alhambra, Madrid (1978).

\bibitem{Ga-83}
{\sc P.L. Garc\'ia},
``Geometric Quantization'',
{\sl Mem. Real Acad. Cienc. Exact. Fis. Natur.} {\bf 11}, Madrid (1979).

\bibitem{GS-dggt}
{\sc M. G\"ockeler, T. Sch\"ucker},
{\sl Differential Geometry, Gauge Theories and Gravity},
...
{\sl J. Math. Phys.} {\bf 19},  (1986) 2051--2066.

\bibitem{Go-cit}
{\sc M.J. Gotay},
``On coisotropic imbeddings of presymplectic manifolds'',
{\sl  Proc. Amer. Math. Soc.} {\bf 84} (1982) 111-114.
...
{\sl Comm. Math. Phys.} {\bf 82}, (1981) 377-389.
...
{\sl Connections, curvature and cohomology},
...
{\sl Invent. Math.} {\bf 67} (1982) 515-538.

\bibitem{Ho-ica}
{\sc L. H\"ormander},
{\sl An Introduction to Complex Analysis in Several Variables},
...
quantization'',
in {\sl Quantization of Constrained Systems and Conformal Field Theory},
...
{\sl J. Phys A. Math. Gen.} {\bf 31}(4) (1998) 1297-1305.
...
\bibitem{Ja-fqm}
{\sc J.M. Jauch},
{\sl Foundations of Quantum Mechanics},
Addison-Wesley, Reading Ma., 1968.

\bibitem{Ki-62}
{\sc A.A. Kirillov},
``Unitary representations of nilpotent Lie groups'',
{\sl Russian Math. Surveys\/}
{\bf 17} (4), (1962) 53-104

\bibitem{Ki-76}
{\sc A.A. Kirillov},
{\sl Elements of the theory of representations\/},
...
(vol 4): {\sl Dynamical Systems (IV) \/},
Springer, Berlin (1985) 137-172.

\bibitem{KN-69}
{\sc S. Kobayashi, K. Nomizu},
{\sl Foundations of differential geometry} (Vol 2),
Wiley, New York, 1969.

\bibitem{Ko-70}
{\sc B. Kostant},
``Quantization and unitary representations'',
{\sl Lects. in Mod. Anal. and Appl. III},
...
{\sc B. Kostant},
``Symplectic spinors'',
{\sl Symposia mathematica} {\bf 14}, Academic Press, London (1974)
139-152.

\bibitem{Ko-77}
{\sc B. Kostant},
``Graded Manifolds, Graded Lie Algebras and Prequantization'',
{\sl Diff. Geom. Meth. in Math. Phys.},
...
{\sl Symplectic geometry and analytical dynamics\/},
...
{\sl J. Math. Phys.} {\bf 38}(12) (1997) 6185-6213.

\bibitem{Lo-90}
{\sc R. Loll},
``Noncommutativity of Constraining and Quantizing: A ${\rm U}(1)$-Gauge
Model'',
{\sl Phys. Rev. D(3)} {\bf 41}(12) (1990) 3785-3791.

\bibitem{Lo-92}
{\sc R. Loll},
``Canonical and BRST Quantization of Constrained Systems'',
Proc. {\sl Mathematical Aspects of Classical Field Theory} (Seattle, WA,
...
{\sl Int. J. Theor. Phys.} {\bf 32}(11) (1993) 2077-2085.

\bibitem{NN-cac}
{\sc A. Newlander, L. Nirenberg},
``Complex analytical coordinates in almost complex manifolds'',
{\sl Ann. Math.} {\bf II} (Ser. 65),
(1957) 391-404.

\bibitem{Ok-87}
{\sc T. Okubo},
{\sl Differential Geometry},
...
algebras'',
{\sl Ann. Sci. \'Ecole Norm. Sup.} {\bf 4}(7) (1974) 155-174.

\bibitem{Se-pgqm}
{\sc I.E. Segal},
``Postulates for General Quantum Mechanics'',
{\sl Ann. Math.} {\bf 4} (1947) 930-948.

\bibitem{Se-60}
{\sc I.E. Segal},
``Quantization of non-linear systems'',
{\sl J. Math. Phys.} {\bf 1} (1960) 468-488.

\bibitem{SW-76}
{\sc D.J. Simms, N.M.J. Woodhouse},
{\sl Lectures on geometric quantization\/},
...
{\sl Ann. Inst. H. Poincar\'e A} {\bf 20} (1974) 365-372.

\bibitem{Sn-80}
{\sc J. \'Sniatycki},
{\sl Geometric quantization and quantum mechanics\/},
...
\bibitem{So-69}
{\sc J.M. Souriau},
{\sl Structure des syst\'emes dynamiques\/},
Dunod, Paris, 1969.

\bibitem{Tu-85}
{\sc G.M. Tuynman},
{\sl Geometric quantization},
...
{\sl J. Math. Phys.} {\bf 28}(3) (1987) 573-583.

\bibitem{Tu-91}
{\sc G.M. Tuynman},
``Quantization of First-Class Constraints with Structure Functions'',
{\sl Lett. Math. Phys.} {\bf 21}(3) (1991) 205-213.

\bibitem{Tu-92a}
{\sc G.M. Tuynman},
``Geometric Quantization of the BRST Charge'',
{\sl Comm. Math. Phys.} {\bf 150}(2) (1992) 237-265.
...
{\sl Mathematical Structures in Field Theory}.
...
\bibitem{We-58}
{\sc A. Weil},
{\sl Variet\'es Kahl\'eriennes\/},
Hermann, Paris, 1958.

\bibitem{Wl-tgqm}
{\sc H. Weyl},
{\sl The Theory of Groups and Quantum Mechanics},
Dover, New York, 1950.

\bibitem{Wn-77}
{\sc A. Weinstein},
{\sl Lectures on symplectic manifolds\/},
C.B.M.S. Reg. Conf. Ser. in Math. {\bf 29},
Amer. Math. Soc., Providence, Rhode Island, 1977.

\bibitem{Wl-85}
{\sc J.R. Wells},
{\sl Differential Analysis on Complex Manifolds},
Springer-Verlag, Heilderberg, 1985.

\bibitem{Wo-80}
{\sc N.M.J. Woodhouse},
{\sl Geometric Quantization\/}, Clarendon Press, Oxford, 1980 ($2^{nd}$
ed. 1992).
