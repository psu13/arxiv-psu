...
\label{depen}
\end{prop}
\noindent{\bf Proof}:  If $s$ has null germ in $m$, then it vanishes
...
\label{clacur}
\end{prop}
\noindent{\bf Proof}: Taking a trivialization
$\{ U_l,s_l \}$,
...
\label{cureal}
\end{prop}
\noindent{\bf Proof}:  We are going to see it for trivializing
...
\label{ihm}
\end{teor}
\noindent{\bf Proof}: See \cite{Ko-70}, p. 110.
\qed
...
\noindent Then $(M,{\cal J})$ is a {\rm complex manifold}.
\end{definition}
...
\noindent There are different ways of characterizing the functions
...
\noindent This way of quantizing is known as the {\it holomorphic} or {\it
...
\eeann
\qed
\noindent Observe that, in general, the equality
$$
\Lie(X) \langle \sigma ,\sigma ' \rangle =
