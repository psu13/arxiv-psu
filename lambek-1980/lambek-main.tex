...
\ees
\bes
A \sland B \xto{\pi_{A,B}} A,\,\,A \sland B \xto{\pi'_{A,B}} B, \quad
...
\item[($4'$)] $\eval_{A,B}\la h^*\pi_{C,B}, \pi'_{C,B}\ra = h$,
$(\eval_{A,B}\la k^*\pi_{C,B}, \pi'_{C,B}\ra)^* = k$,
...
that:
$$
\eval\bracket{(g\alpha)^*\bracket{x0,1}\pi,\pi'} \eqx g\bracket{x0,1}
$$
