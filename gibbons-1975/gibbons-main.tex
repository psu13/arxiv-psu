...
In fact in any electromagnetic background which is stationary, axisymmetric and
...
\be
E^\pm = e\mathop\Phi + (L + eB)\Omega \pm \sigma^2 \sqrt{m^2 + (L + eB)^2} .
\ee
\ni
...
first of which is most pertinent to the final section:
...
\bibitem[1]{1} R. Penrose. Riv. Nuovo Cimento {\bf 1} 252 (1969)

\bibitem[2]{2} G. Denardo \& A. Treves. Lett. al. Nuovo Cimento {\bf 8} 295 (1973)
...
\bibitem[4]{4} C. Misner. Bull. Amer. Phys. Soc. {\bf 17} 472 (1972)

\bibitem[5]{} Ya. Zeldovich J.E.T.P. {\bf 35} (1972)

\bibitem[6]{} O. Klein, Zeit. fur Phys. {\bf 53} 157 (1929)

\bibitem[7]{7} W. Unruh. Phys. Rev. Lett. {\bf 31} 1265 (1973)
...
\bibitem[13]{13} Ya. Zeldovich. J.E.T.P. \textbf{446} (1962) 
