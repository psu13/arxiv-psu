...
tensor of a spin ½ ﬁeld does not obey the positive energy condition. Note that in both
...
This does not always yield a sensible theory [41] but in the case of spin 0, ½ and 1 a workable
theory results.
...
\int \bar\psi\gamma^\mu\psi d\Sigma^\mu \quad & \text{for spin ½}
\end{align}
...
will give an inequivalent definition of the vacuum state. Indeed it --- as
seems to occur in most practical examples the number of ``created particles'' diverges
...
Indeed one canshow that the gravitational field of a plane wave (like a plane electromagnetic wave)
...
representations of the Poincare Group [26]. Neither of these concepts is applicable near the black hole.
