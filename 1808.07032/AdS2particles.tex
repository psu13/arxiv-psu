...
\includegraphics{geometry1} & \includegraphics{geometry2}
\vspace{8pt}\\
a) & b)
\end{tabular}}
...
\includegraphics{jagged1} & \includegraphics{jagged2}
\vspace{8pt}\\
a) & b)
\end{tabular}}
...
\end{aligned} \quad  \figbox{1.1}{Wdiag}}
\ee
...
\begin{figure}[t]
\centerline{\begin{tabular}{@{}c@{\hspace{4cm}}c@{}}
\includegraphics{Sch_prop} & \includegraphics{corrcon} \\
a) & b)
\end{tabular}}
...
\includegraphics[scale=0.95]{conPI} & \includegraphics[scale=0.95]{conGm} & \includegraphics[scale=0.95]{conGp}\\
a) & b) & c)
\end{tabular}}
