...
is $\impl$-introduction.%
\footnote{Editor's note: This seems backwards? In natural deduction this would be elimination.}
It plays the role of the Modus Ponens inference rule (although here it is a
constant, and not a binary operator). Abstraction is $\impl$-elimination,%
\footnote{This also seems backwards?}
