...
%
%
\documentclass[prd,amsmath,amssymb,12pt]{revtex4}
...
\usepackage[papersize={7.4in, 10.0in}, left=.5in, right=.5in, top=.6in, bottom=.9in]{geometry}
\linespread{1.1}
\sloppy
\raggedbottom
\pagestyle{plain}
...
The program identifies ``cats'' as being very similar to ``dog'' and ``cat'' according to some real-valued similarity metric.
