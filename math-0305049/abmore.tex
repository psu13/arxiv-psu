...
\newcommand{\neeq}{\rotatebox{45}{$=$}}
\newcommand{\nuzeropic}{{\!\!\!\begin{array}{c}\raisebox{-0.5ex}{\epsfig{file=nuzeropic.eps}}\end{array}\!\!\!}}
\newcommand{\nutwopic}{{\!\!\!\begin{array}{c}\epsfig{file=nutwopic.eps}\end{array}\!\!\!}}
\newcommand{\lambdapic}{{\!\!\!\begin{array}{c}\epsfig{file=lambdapic.eps}\end{array}\!\!\!}}
\newcommand{\rhopic}{{\!\!\!\begin{array}{c}\epsfig{file=rhopic.eps}\end{array}\!\!\!}}
\newcommand{\assleftpic}{{\!\!\!\begin{array}{c}\epsfig{file=assleftpic.eps}\end{array}\!\!\!}}
\newcommand{\assrightpic}{{\!\!\!\begin{array}{c}\epsfig{file=assrightpic.eps}\end{array}\!\!\!}}
\mcm{\utree}{0}{\, | \,}
