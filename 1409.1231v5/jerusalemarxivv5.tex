...
Let's now focus on a black hole created from the collapse of a photon shell; the Penrose diagram is shown in figure \ref{collapse2}.
\begin{figure}
\begin{center}
...
To see the trans-Planckian collision with the initial shell more explicitly,  we can note from \eqref{nullg} that an ingoing null geodesic that crosses the potential barrier at time $t=0$ intersects an outgoing geodesic that crosses the potential barrier at time $t_{\mathit{out}}\gg r_s$ at
\be
