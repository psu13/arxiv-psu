...
\documentclass[rmp,twocolumn,aps]{revtex4}
%,superscriptaddress
\usepackage{graphicx}
...
%INSERTING FIG
\begin{figure*}[htb]
\includegraphics[width=7in, clip=true]{hanson_fig05.eps}
...
%INSERTING FIG
\begin{figure*}[hbt]
\includegraphics[width=6.9in, clip=true]{hanson_fig07.eps}
...
\begin{figure*}[hbt]
\includegraphics[width=6.8in, clip=true]{hanson_fig29.eps}
