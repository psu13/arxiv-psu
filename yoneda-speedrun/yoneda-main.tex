...
FX$, both naturally in $X$ and naturally in $F$. Likewise for any contravariant functor $F:\CC \to \Set$ (equivalently, covariant functor $F:\CC^\op \to \Set$),
...
\begin{lemma}[Yoneda]\label{yoneda-perrone} Let $\cat{C}$ be a category, let $X$ be an
 ...
 the identity at $X$. This assignment is a bijection, and it is natural both in $X$ and in $F$.
\end{lemma}
\noindent
