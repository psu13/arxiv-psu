...
Your reward for having climbed with me all the way up to the lemma
...
higher.\footnote{We should have also defined this as
...
in a category can be understood by understanding the maps into (or out of) it.''
More precisely:
\begin{cor}
