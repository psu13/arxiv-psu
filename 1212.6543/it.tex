...
\subsection{Three misconceptions}
...
\subsection{Building on the axioms}
...
\subsection{How strong are the axioms?}
...
\subsection{What kind of set theory should we teach?}
...
\subsection{Reactions to an earthquake}
