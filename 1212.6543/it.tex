...
\usepackage[text={156mm,244mm},centering]{geometry}
\newlength{\colsep}
\setlength{\colsep}{4ex}
\usepackage{multicol}
...
\end{trivlist}
% 
---Sheldon Axler~\cite[Section 10]{AxleDWD}.
...
\put(0,0){\includegraphics[width=48\unitlength]{loop.pdf}}
\put(5,-3.5){$S^1$}
\put(33,-3.5){$X$}
\put(18,-8){(a)}
% 
\put(60,0){\includegraphics[width=45\unitlength]{line.pdf}}
\put(69,-3.5){$\reals$}
\put(96,-3.5){$\reals^n$}
\put(81,-8){(b)}
% 
\put(119.5,0.5){\includegraphics[width=37\unitlength]{element.pdf}}
\put(120.5,-3){$\One$}
\put(144,-3){$X$}
\put(132,-8){(c)}
\end{picture}
