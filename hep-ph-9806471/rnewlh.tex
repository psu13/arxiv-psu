...
To this end let us
consider ${\cal H}_{\it eff}$ as the
...
{\cal H}_{\it eff}=C^{(0)}_iQ_i(q^{(0)})\equiv Z^2_qZ^c_{ij} C_jQ_i\equiv
...
A_{\it eff}= Z^2_qZ^c_{ij} C_j\langle Q_i\rangle^{(0)} \end{equation}
On the other hand using (\ref{q0zq}), we have
\begin{equation}\label{zqa}
A_{\it eff}=C_j\langle Q_j\rangle=C_j Z^{-1}_{ji} Z^2_q \langle Q_i\rangle^{(0)}
\ee
