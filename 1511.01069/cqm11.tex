...
\usepackage{amsmath,amssymb,euscript,array,mathrsfs,ctable,marvosym}
...
\author{
\name{Timothy J. Hollowood}
\affil{Department of Physics, Swansea University, Swansea SA2~8PP, U.K.}
...
\begin{keywords}
measurement problem; Copenhagen interpretation; quantum trajectories; decoherence; quantum jumps
\end{keywords}
...
\bibitem{WW}
V. ~F.~Weisskopf and E.~Wigner, ``Berechnung der natürlichen linienbreite auf grund der diracschen lichttheorie,"  Z. Phys. {\bf63} (1930) 54. 
