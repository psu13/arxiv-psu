...
\documentclass[aps,prx,amsmath,amssymb,amsfonts,lengthcheck,twocolumn]{revtex4}
...
\end{tabular}
\caption{Envariance -- {\it en}tanglement assisted in{\it variance} -- is a symmetry of entangled states. Envariance allows one to demonstrate Born's rule \cite{76,78,75} using a combination of an old intuition of Laplace \cite{40}
...
Raimond, V Rivasseau), pp. 151-175. Basel, Switzerland: Birkh‰user.

\bibitem{12} Born, M., 1926, Zur Quantenmechanik der Stoﬂvorg‰nge. Z. Phys. 37, 863-867.
