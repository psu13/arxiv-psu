...
temperature $\beta$, then it will be described by a density matrix $\rho =\exp
...
A(t_1)B(t_2)\rangle ={\rm tr}\, (\exp -\beta H)A(t_1)B(t_2) ={\rm tr}\,
B(t_2)(\exp -\beta H)A(t_1) ={\rm tr}\, B(t_2)A(t_1+\i\beta )(\exp -\beta H)
={\rm tr}\, (\exp -\beta H)B(t_2)A(t_1+\i\beta )=\langle B(t_2)A(t_1+\i\beta
