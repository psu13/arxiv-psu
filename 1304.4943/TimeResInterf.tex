...
\centering
\begin{tabular}{c c}
\multirow{3}{*}{\subfigure[$N=200$, $t=115$ ms]{\includegraphics[width=0.47\columnwidth]{fig2a}}}  & \vspace{2.8cm}
...
\subfigure[\ coefficeint of determination ]{\includegraphics[width=0.44\columnwidth]{fig3a}} &
