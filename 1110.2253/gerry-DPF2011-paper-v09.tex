...
%%%
\documentclass[letterpaper,twoside,preprintnumbers,slac_one]{revtex4}
\usepackage{graphicx}
\usepackage{fancyhdr}
...
\usepackage{hyperref}
\hypersetup{
  pdftitle    = {Spontaneous Symmetry Breaking},
  pdfauthor   = {Gerald S. Guralnik <gerry@het.brown.edu>},
  pdfsubject  = {High Energy Physics - Theory},
  pdfcreator  = {LaTeX2e with hyperref package},
  pdfproducer = {pdflatex},
  pdfkeywords = {Quantum Field Theory, Schwinger-Dyson Equations, Lattice,
    Symmetry Breaking, Non-Perturbative QFT},
  pdfview     = {FitH}
}
\usepackage{ucs}
