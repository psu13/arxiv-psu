...
\documentclass[prx,11pt,letterpaper,twocolumn,accepted=2023-11-27]{quantumarticle}
\pdfoutput=1
\usepackage[letterpaper,margin=0cm,bottom=0.1cm]{geometry}
...
\usepackage[unicode=true,pdfusetitle, bookmarks=false,bookmarksnumbered=false,
bookmarksopen=false, breaklinks=false,pdfborder={0 0 0},backref=false,
colorlinks=true,
linkcolor=carmine,
citecolor=googleblue,
urlcolor=panblue,
anchorcolor=OliveGreen,
%linkcolor=myrefcolor,citecolor=myurlcolor,urlcolor=myurlcolor
]{hyperref}
