...
\begin{figure} 
\centerline{\mbox{\epsfig{file=RovelliFig2.eps}}} 
\caption{The elementary vertex.} 
\end{figure}

An example of a surface in the sum is given in Figure 4.

\begin{figure} \centerline{\mbox{\epsfig{file=RovelliFig3.eps}}}
...
are simply obtained by re-orienting Figure 3 in spacetime.
 \begin{figure}
 \centerline{\mbox{\epsfig{file=RovelliFig4.eps}} \hskip1cm 
 \mbox{\epsfig{file=RovelliFig5.eps}}}
