...
\medskip
\noindent{\bf FQ1}: What does he mean they are analogous? Did he mean they are equal? Did he mean they are proportional?
...
Feynman justified his equation (\ref{eq:missinglink0}) by the fact that it led to the Schr\"odinger eqn. with what appeared to be the correct
...
\{\frac{1}{f_0}\,\frac{{\partial}^2\,\psi(x,t)}{{\partial}^2\,x} +  \frac{{\partial}^2\,\psi(x,t)}{{\partial}^2\,x}\,\frac{1}{f_0}\}
 + V(x)\psi(x,t)
\ee
In other words, the choice of $S^*$ as per equation (\ref{eq:Sstar}) leads to the quantum Hamiltonian
\be
\label{eq:HqSstar}
...
Hamiltonians given by equation (\ref{eq:HqSstar}), generically different from the Feynman case.
...
This section should also enable readers to make a comparison between the Feynman path-integrals of equation (\ref{eq:feynpathint0}) and the newly
introduced Dirac path-integrals of equation (\ref{eq:diracpathint*}). 
...
\bibitem{gleick} James Gleick, {\it Genius: The Life and Science of Richard Feynman}
