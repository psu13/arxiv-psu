...
\end{center}
\noindent
Hawking's original paper observed that the Hawking radiation occurs because while 
the vacuum states of the fields are empty near $\scri^-$ these same states will contain
particles when observed at  $\scri^+$. To work out how many such particles appear at $\scri^+$
Hawking traces a wave packet from $\scri^+$ back through the shell to $\scri^-$.
