...
% Other packages
\usepackage[left=2.5cm,right=2.5cm,top=2.7cm,bottom=2.7cm]{geometry} % we can adjust these values (making sure that title and TOC page look good)
...
urlcolor=darkblue, linkcolor=black, citecolor=black, %}
}
\pdfinfo{%
  /Title    (\tit)
  /Author   (\auth)
