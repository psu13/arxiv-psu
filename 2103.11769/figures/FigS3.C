...
//=========  (Fri Mar 19 08:23:41 2021) by ROOT version 6.18/04
   ...
   Graph_Graph23003->SetMinimum(0.7967186);
   Graph_Graph23003->SetMaximum(0.8984429);
   ...
   entry->SetMarkerSize(1.3);
   entry->SetTextFont(132);
   entry=leg->AddEntry("Graph2","LHCb 9 fb^{-1}","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
