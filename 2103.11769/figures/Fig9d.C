...
//=========  (Thu Mar 18 17:20:54 2021) by ROOT version6.08/06
   ...
   canv->Range(-512.3457,0.8594937,5290.123,1.112658);
   canv->SetFillColor(0);
   ...
   canv->SetFrameLineWidth(2);
   canv->SetFrameBorderMode(0);
   Double_t xAxis1[9] = {300, 850, 1100, 1400, 1750, 2200, 2800, 3700, 5000}; 
   
   TH1F *rJPsi0__1 = new TH1F("rJPsi0__1","eeYield",8, xAxis1);
   rJPsi0__1->SetBinContent(1,0.9830341);
   rJPsi0__1->SetBinContent(2,0.9850469);
   rJPsi0__1->SetBinContent(3,1.034286);
   rJPsi0__1->SetBinContent(4,0.9953955);
   rJPsi0__1->SetBinContent(5,1.002067);
   rJPsi0__1->SetBinContent(6,0.9738212);
   rJPsi0__1->SetBinContent(7,1.002405);
   rJPsi0__1->SetBinContent(8,1.010426);
   rJPsi0__1->SetBinError(1,0.01527807);
   rJPsi0__1->SetBinError(2,0.01189798);
   rJPsi0__1->SetBinError(3,0.01296231);
   rJPsi0__1->SetBinError(4,0.01123082);
   rJPsi0__1->SetBinError(5,0.01128208);
   rJPsi0__1->SetBinError(6,0.01012419);
   rJPsi0__1->SetBinError(7,0.01080097);
   rJPsi0__1->SetBinError(8,0.01381734);
   rJPsi0__1->SetMinimum(0.9);
   rJPsi0__1->SetMaximum(1.1);
   rJPsi0__1->SetEntries(52866.96);
   rJPsi0__1->SetStats(0);
   rJPsi0__1->SetLineWidth(2);
   rJPsi0__1->SetMarkerStyle(20);
   rJPsi0__1->GetXaxis()->SetTitle("min(#it{p}_{T}(#it{l^{+}}), #it{p}_{T}(#it{l^{#minus}})) [MeV/#it{c}]");
   ...
   rJPsi0__1->Draw("E1");
   TLine *line = new TLine(300,1,5000,1);
   line->SetLineStyle(3);
   line->SetLineWidth(2);
   line->Draw();
