...
\usepackage[papersize={7.2in, 10in}, left=.5in, right=.5in, top=1in, bottom=1in]{geometry}
\tolerance=2000
...
theorems, where the
necessary symbols are defined in section (4) below.
...
the state $(\a ){}^n|0\rangle_{in}$ contains $n$ {\it in}-particles of energy
$\omega$. This is
