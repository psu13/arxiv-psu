...
%
The vacuum, or lowest energy state, which we denote $|0\langle_{in}$,
is the state which is annihilated by all the annhilation operators $\a$,
%
\be\label{avac} \a |0\langle_{in} =0 \quad\ee
%
for all $\omega>0$.
The standard Fock space of states is then constructed by applying arbitrary
products of creation operators to $|0\langle_{in}$.  For example,
the state $(\a ){}^n|0\langle_{in}$ contains $n$ {\it in}-particles of energy
$\omega$. This is
...
%
\be\label{outin}{}_{in}<0|  (N_\omega ^{out} )   |0\langle_{in} \equiv
{}_{in}<0|\bd \b |0\langle_{in} = \int d\omega ' | \beta  _{\omega \omega^\prime
} |^2 \ee
%
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=1.75in]{minkowski.eps}
\end{center}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=1.75in]{kruskal.eps}
\end{center}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=1.75in]{collapse.eps}
\end{center}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=1.75in]{desitter.eps}
\end{center}
