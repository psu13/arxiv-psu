...
%%% Preamble
\documentclass[DIV=calc,paper=a4,fontsize=12pt]{scrartcl} % KOMA-article class
...
\begin{figure}[t!]
\centering
\subfloat[\color{blue} An ontic state is a point in phase space.]{\includegraphics[width=75mm]{Fig1a.pdf}}\\
\subfloat[\color{blue} An epistemic state is a probability density on phase space. Contours indicate lines of equal probability density.]{\includegraphics[width=75mm]{Fig1b.pdf}}\\
\subfloat[\color{blue} An ontic state (cross) is deemed possible in more than one epistemic state ($f_1$ and $f_2$).  Phase space has been schematically collapsed down to one dimension for illustrative purposes.]{\includegraphics[width=75mm]{Fig1c.pdf}}
...
states.]{\includegraphics[width=75mm]{Fig9a.pdf}\label{fig:POEM:relabel:start}}\\
...
part of the ontology.]{\label{fig:POEM:relabel:end}\includegraphics[width=75mm]{Fig9c.pdf}}
