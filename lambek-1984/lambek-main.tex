...
\lx \pf(x) \equiv f^*,
\]
where $f$ is the constant from Theorem 4.2. It follows that
\[
\lx \pf(x) \app a = \pf(a).
\]
...
\lx \pf(x) & \,\, \text{by functional completeness.%
\footnotemark}
\end{align*}
\footnotetext{This is clearly missing a right hand side. Oh well}
