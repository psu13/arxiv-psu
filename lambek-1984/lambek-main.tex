...
\footnote{Editor's Note: Here $\pf(x)$ is notationally subtle. It names an arrow from $B \to C$.
It confusingly looks like the normal notation for a mathematical function that maps $x$ to something
in $C$. But it isn't.}
\]
\end{prop}
