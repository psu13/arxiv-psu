...
\footnote{Editor's note: This notation $\pf(x)$ is endlessly confusion to me.
You want to think that $\pf$ maps $x \in B$ to something in $C$ 
but that's not that is going on.
What's going on is that the object $\pf(x)$ labeled by $x$ is something that maps
things in $B$ to things in $C$. At least that's the only way the notation
makes sense to me.}
