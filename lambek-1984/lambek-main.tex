...
$\pf(x): B to C$ under the assumption $x: D \to A$ there is a unique
...
{\inferrule*
{\inferrule* 
	{B \sland D \imp D \\ D \sxto{x} A}
	{B \sland D \to A}
}
{\inferrule * {B \to (D \impl A) \\ B \to B} {B \to (D \impl A) \sland B}} \\ (D \impl A) \sland B \sxto{f} C}
{B \to C}
\]
