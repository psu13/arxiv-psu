...
\includegraphics[scale=0.9]{geometry1} & \includegraphics[scale=0.9]{geometry2}
\vspace{8pt}\\
a) & b)
\end{tabular}}
...
\begin{figure}[t]
\centerline{\begin{tabular}{c@{\hspace{3cm}}c}
\includegraphics{up} & \includegraphics{down}  \\
a) & b) 
\end{tabular}}
...
\includegraphics[scale=1.3]{scattering} & \includegraphics[scale=1.5]{amp_1} & \includegraphics[scale=1.5]{amp_cl}\\
&\vspace{1pt}  &\\
a) & b) & c)
\end{tabular}
}
