...
\begin{figure*}
	...
	\begin{center}
		...
		\begin{tabular}{  c | c | c  c  c  c  c c }
			...
			\\          
			&\vspace{-.1in} &&&&&&\\
			\multirow{1}{*}[0.7in]{ \rotatebox[origin=t]{90}{  \specialcell{ \small{\textsf{StarWarps:}} \\  \small{\textsf{Learn Warp}}}  }}
			&
			...
			%\hspace{0.02in} 
			{{\includegraphics[height=0.12\linewidth]{figures/recov_flowfields/rot30_vis/flow_noaxis.pdf}} } &
			...
			%\hspace{0.02in} 
			{{\includegraphics[height=0.12\linewidth]{figures/recov_flowfields/rot30_bis/flow_noaxis.pdf}} } &
...
\begin{figure*}
	\begin{center}
		...
		\begin{tabular}{  c | c | c  c  c  c  c c }
			...
			%\hspace{0.02in} 
			{{\includegraphics[height=0.12\linewidth]{figures/recov_flowfields/hotspot100sR2_vis/flow_noaxis.pdf}} } &
			...
			%\hspace{0.02in} 
			{{\includegraphics[height=0.12\linewidth]{figures/recov_flowfields/hotspot100sR2_bis/flow_noaxis.pdf}} } &
