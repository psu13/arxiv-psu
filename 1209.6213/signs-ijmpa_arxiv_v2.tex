...
\psfrag{n}{$\nu,b$}
\psfrag{G}{$g$}
\put(5,6){\includegraphics[width=3.5cm]{itcc5f1abc-new.eps}}
\end{picture}
}
...
\psfrag{a}{$a$}
\psfrag{b}{$b$}
\put(5,6){\includegraphics[width=3.5cm]{GluonGhostPropagatorFR.eps}}
\end{picture}
}
...
\psfrag{p2}{$p_2$}
\psfrag{p3}{$p_3$}
\rput(2,1.2){\includegraphics{VertexAAA.eps}}
}
...
\psfrag{p2}{$p_2$}
\psfrag{p3}{$p_3$}
\rput(2,1){\includegraphics{VertexGGA-signs.eps}}
}
...
\psfrag{n}{$\nu$}
\psfrag{G}{$\gamma$}
\put(2,6){\includegraphics[width=3.5cm]{itcc5f1abc-new.eps}}
\end{picture}
}
...
\begin{picture}(0,0)
\psfrag{p}{$p$}
\put(2,2){\includegraphics[width=3.5cm]{itcc5f1e-new.eps}}
\end{picture}
}
...
\psfrag{p}{$p$}
\psfrag{H}{$h$}
\put(2,-2.8){\includegraphics[width=3.5cm]{HiggsPropagator.eps}}
\end{picture}
}
...
\psfrag{p}{$p$}
\psfrag{H}{$\varphi_Z$}
\put(2,-2.5){\includegraphics[width=3.5cm]{HiggsPropagator.eps}}
\end{picture}
}
...
\psfrag{W2}{$W_{\rho}^+$}
\psfrag{A}{$A_{\mu}$}
\put(0.9,10){\includegraphics[width=30mm]{itchome2009-Fig1.eps}}
\end{picture}
}
...
\put(0.9,-4.5){\includegraphics[width=30mm]{itchome2009-Fig2.eps}}  
\end{picture}
}
...
\psfrag{W3}{$W_{\rho}^-$}
\psfrag{W4}{$A_{\nu}$}
\put(2,-5){\includegraphics[width=35mm]{WPWMWPWM.eps}}
\end{picture}
}
...
\psfrag{x2}{$u_\alpha$}
\psfrag{W}{$W^+_{\mu}$}
\put(20,0){\includegraphics[width=28mm,clip]{CorrenteCarregada-signs.eps}}
\end{picture}
}
...
\psfrag{Z}{$Z_{\mu}$}
\psfrag{A}{$A_{\mu}$}
\put(20,-1){\includegraphics[width=27mm]{CorrenteNeutra-A.eps}}
\end{picture}
}
...
\psfrag{Z}{$Z_{\mu}$}
\psfrag{A}{$A_{\mu}$}
\put(20,0){\includegraphics[width=27mm]{CorrenteNeutra-Z.eps}}
\end{picture}
}
...
\psfrag{f1}{$f$}
\psfrag{f2}{$f$}
\put(20,-3){\includegraphics[width=30mm]{PsiPsiHiggs.eps}}  
\end{picture}
}
...
\psfrag{f1}{$f$}
\psfrag{f2}{$f$}
\put(20,-4){\includegraphics[width=30mm]{PsiPsiHiggs.eps}  }
\end{picture}
}
...
\psfrag{p1}{$p_{-}$}
\psfrag{p2}{$p_{+}$}
\put(20,-5){\includegraphics[width=30mm]{PhiPhiGauge.eps}  }
\end{picture}
}
...
\psfrag{p1}{$p_{-}$}
\psfrag{p2}{$p_{+}$}
\put(20,-3.5){\includegraphics[width=30mm]{PhiPhiGauge.eps}}
\end{picture}
}
...
\psfrag{p1}{$\, k$}
\psfrag{p2}{$p$}
\put(20,-4){\includegraphics[width=30mm]{PhiPhiGauge.eps}}
\end{picture}
}
...
\psfrag{A}{$\!\! W_\nu^\pm$}
\psfrag{s}{$\varphi^\mp$}
\put(20,-6){\includegraphics[width=30mm]{PhiGaugeGauge.eps}}
\end{picture}
}
...
\psfrag{A}{$\!\! Z_\nu$}
\psfrag{s}{$h$}
\put(20,-4){\includegraphics[width=30mm]{PhiGaugeGauge.eps}}
\end{picture}
}
...
\end{equation}
  \begin{picture}(0,5)
    ...
    \psfrag{V3}{$W_{\mu}^\pm$}
    \psfrag{V4}{$W_{\nu}^\mp$}
   \put(15,-4){\includegraphics[width=40mm]{H1H2V3V4.eps}}
  \end{picture}
}
