...
Fényes~\citep{Fenyes:1952ewbuidq}, and Nelson~\citep{Nelson:1966dtobm,Nelson:1985qf}.
...
the \emph{Schrödinger picture}. It will also end up being useful
...
in the context of transformations of the Schrödinger equation between
...
to the \emph{Schrödinger equation}, 
\begin{equation}
...
Furthermore, one can write the Schrödinger equation \eqref{eq:SchrodingerEq}
as 
\begin{equation}
...
The appearance of the Schrödinger equation \eqref{eq:SchrodingerEq}
...
systems have Schrödinger waves that propagate through high-dimensional
configuration spaces, as was noted by Schrödinger himself in his early
...
configuration spaces for Schrödinger waves altogether.
...
is really a Schrödinger wave of some kind, or that the particle fails
...
In response to this last point, one might suggest that Schrödinger
...
the slits on each run of the experiment. A two-particle system's Schrödinger
...
quantum fields are conceptually distinct from Schrödinger wave functions.
