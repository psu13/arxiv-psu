...
%\usepackage{eulervm}
\linespread{1.05}
\usepackage[papersize={7in, 10in}, left=.6in, right=.6in, top=1in, bottom=1in]{geometry}
\sloppy
...
space \(T_xM\). We shall often write \(\ \langle v,w \rangle_x\)
\index{\(V,W_X\)@\(\ \langle v,w \rangle_x\)}%
 in place of
