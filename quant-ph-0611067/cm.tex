\documentclass[aps,twocolumn,superscriptaddress,footinbib,floatfix,showpacs]{revtex4}
...
\typeout{*****}
\typeout{*****}
\typeout{***** NOTE: must use distiller to make pdf, not ps2pdf for gaussian aperture}
\typeout{ figure to come out right!!!!}
\typeout{*****}
\typeout{*****}
\typeout{*****}
\typeout{*****}
