...
\usepackage[papersize={6.8in, 10in}, left=.5in, right=.5in, top=1in, bottom=1in]{geometry}
\tolerance=2000
\hbadness=2000
...
\begin{picture}(1,0.4)
\put(0,0){\includegraphics[width=0.6\textwidth]{Redundancy_delta.pdf}} \put(0.52,0.37){\mbox{\large\textbf{(a)}}}
\put(0.575,0.275){\includegraphics[width=0.42\textwidth]{Redundancy1.pdf}} \put(0.91,0.375){\mbox{\large\textbf{(b)}}}
\put(0.575,0.14){\includegraphics[width=0.42\textwidth]{Redundancy2.pdf}} \put(0.91,0.253){\mbox{\large\textbf{(c)}}}
\put(0.575,0){\includegraphics[width=0.42\textwidth]{Redundancy3c.pdf}} \put(0.91,0.12){\mbox{\large\textbf{(d)}}}
\end{picture}
