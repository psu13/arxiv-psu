...
$g$ and the map $h$ into the product. This all now makes $A times B$ well behaved within
the category.
...
function spaces. $\l$-calculus, then, becomes mostly a notational de vice for setting down
...
statements in the language ``true'' about the model. It depends on the na,ture of the
...
constant O should figure in the language, but it is not all that essential.)
