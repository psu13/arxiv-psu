...
$r,\ol{r}$ by $r',\ol{r}'$. Now, 
\bean [\ol{X},t]-[\ol{X}',t'] &=& [\ol{X},\id_{E_1(\ol{X})} \otimes E_2(\ol{r}^*)\mcirc
...
\lefteqn{ \langle d^E_{X,Y}(u'\otimes v'),d^E_{X,Y}(u\otimes v)
  \rangle_{X\otimes Y}
...
\[ u_{i+j+k}^*\mcirc S_{i+j}^X\otimes \id_{X^{\otimes k}}\mcirc u_i\otimes u_j\otimes u_k
