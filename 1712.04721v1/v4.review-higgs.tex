...
\begin{align}
\langle \op^\dagger(x) \op(y)\rangle&=\int{\cal D}w\left(~\int_\text{Selected stratum}{\cal D}\phi \op^\dagger(x)\op(y)e^{iS}\right.\nonumber\\
& \qquad +\left. \int_\text{Other strata}{\cal D}\phi\op^\dagger(x)\op(y)e^{iS}\right)\nonumber\\
