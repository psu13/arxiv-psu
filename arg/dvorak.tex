...
\title{Dvo\v{r}\'ak Overview 1998}
\date{}
\maketitle

\addcontentsline{toc}{section}{\protect\textbf{Introduction}}
\noindent
Dvo\v{r}\'ak was an inventive and spontaneous composer---a ``natural''.
...
and more and more we are living in a world with no sense of grandeur or majesty. Dvo\v{r}\'ak can be made exciting
and will always be beautiful-without grandeur, but something will also be missing.
Antonin Dvo\v{r}\'ak was born September 8, 1841 in Bohemia, the eldest of eight children 
...
To discover a new Dvo\v{r}\'ak work is to enlarge one's list of favorites. Everyone knows the 9th Symphony---the New World---and when you go back from there you find one sparkling treasure after another. Many critics consider 7 and 8 greater symphonies than 9. Wherever it is performed, audiences still greet 6 with spontaneous enthusiasm. \No5 is exciting, and \No4 has two powerful Dvo\v{r}\'ak hythms. The Third is sumptuous in its orchestration, and \No1 is very winsome. Only \No2 can safely be ignored.

\section{Symphonies}
The late publication dates of many Dvo\v{r}\'ak symphonies account for the numbering problem.
...
\end{enumerate}
Some of the important books about Dvo\v{r}\'ak were published before the early symphonies were published. For example, Alec Robertson's book has a chapter on the symphonies that acknowledges right off that ``I can only speak of the first three symphonies at second hand'', and he proceeds to say almost nothing---and nothing worthwhile---about 1 and 2.

\subsection*{Symphony 1}

People who write about Dvo\v{r}\'ak's symphonies are very condescending about \No1. Karl Schumann's notes for the Kubelik set begin with something that does seem true:
\begin{quote}
Dvo\v{r}\'ak, with the emotional directness of his Slavic nature, open-hearted and filled with the urge to pour out his feelings in music, was too naive to experience the doubts that afflicted other composers when it came to tackling the problems of the symphony.
\end{quote}
Having said that, he points out that Dvo\v{r}\'ak wrote No. 1 when he was only 23, "although he had not mastered the problems which the form posed". He goes on to say that the work "shows the hand of a beginner". And that's about it: he says almost nothing further about it.
...
The finale is typical of Dvo\v{r}\'ak; it even has a great example of ``Dvo\v{r}\'ak rhythm''.
And it builds to a thrilling conclusion. Every time I listen to this symphony I love it more. It certainly has a bit of Schumann in it---and of Mendelssohn---but it is truly Dvo\v{r}\'ak: full of his special genius and the splendor of his orchestral sounds. Yet Dvo\v{r}\'ak never heard it, and it wasn't published until 1961. The Kertesz was the first recording (1965, I think).
...
that you blink Still, What is Dvo\v{r}\'ak without those thrilling Czech violins? 
...
Dvo\v{r}\'ak was inclined to work his violins hard; they carry much of the music. 
...
of vintage-type Dvo\v{r}\'ak themes...remind one of Tchaikovsky''). 
...
``broad sweep'' or ``Dvo\v{r}\'ak-type themes'' at all---and Tchaikovsky is the last composer
one would be reminded of. All of us agree that the Second is the weakest Dvo\v{r}\'ak symphony,
...
the Prague Philharmonic. It's the only Dvo\v{r}\'ak symphony with only three movements. 
...
section in pure Dvo\v{r}\'ak rhythm (dum, dum, dum-da-DUM-dum) acts as a scherzo.
It builds up, then sub-sides; but it returns slower and quieter in the coda
of the movement. Dvo\v{r}\'ak still hasn't written a good slow movement, 
...
Dvo\v{r}\'ak has Schubert's light-hearted playful-ness, too. Still, the orchestration of this symphony is sumptuous, almost Wagnerian. But, Schubert and Wagner aside, Dvo\v{r}\'ak always sounds only like Dvo\v{r}\'ak---he could never be mistaken for anyone else. And he loved this symphony all his life. Brahms loved it, too, and thought it worthy of the Austrian State Prize.
(The critic Hanslick was also on the committee, and Dvo\v{r}\'ak got a five-year government grant out of it.)
...
This is less smooth and flowing than \No3. It has two striking Dvo\v{r}\'ak rhythms
and two gorgeous flowing melodies. You get one of each in I; the rhythm is TA-ta-tum-te-DUM. II is a long theme with variations-very Wagnerian; it is not very original, but it's his best slow movement so far. Ill is a swaggering scherzo-village music. Then comes the repetitious IV, where the first theme is another Dvo\v{r}\'ak rhythm---rum-tum, RUM-ti-tum---heard 17 times—and the second one of his trademark flowing melodies. The overall
impression when you've heard it all is of exuberant grandeur-and maybe that's a good description of Dvo\v{r}\'ak's music in general.
...
Macal is choppier and more energetic than Järvi---or almost anyone else---but I prefer Dvo\v{r}\'ak smoother and more relaxed. IV is about as good as it gets anywhere. Koss's notes are not well written.

The old Rowicki is pretty good---one of his better Dvo\v{r}\'aks. Mr Haldeman calls the ansons fresh and spontaneous, but others don't know it. Steven Haller liked the Naxos Gunzenhauser, but it is coupled
...
The Seventh was written for the London Philharmonic in 1885, and Dvorak conducted the first performance. 
...
Other eminent critics have called it profusely inspired and a great symphony by any stan-dard. Many think it is Dvorak's greatest.
It is also his most Brahmsian. It took him only three months to write it—not surprising, considering the level of inspiration. Some people hear hints of two great themes in it: the second theme in I resembles the beautiful cello solo in the Second Brahms Piano Concerto, and in Il one spot sounds like the love duet from Tristan and Isolde. (To me it all sounds like Brahms, not Wagner.) The Scherzo trips along lightly and cheerfully; conductors are inclined to over-inflect it, but it's really a prime example of the natural flow of Dvorak's music. Yet there is passion in this symphony, and that can be slighted as well. It's not an easy work to get right.
