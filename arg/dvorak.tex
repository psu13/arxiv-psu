...
The title and the music suggest a music: evening in an aristocratic drawing room. It courtly music---quite elegant---and only lets go a little in the final movement (of five). This is the earliest Dvorak composition (1875) that almost any listener will be enchanted by. (I don't mean to detract from the early symphonies---I like them very much.)
...
Ashkenazy (with the Cleveland Orchestra) was rather dry and even heavy. Belohlavek is full of irritating exaggerations. The opening Moderato is a dirge; the Scherzo flies by much too fast. The chamber orchestra (it's not the Czech Philharmonic) doesn't sound that good, either.
...
The Granada Chamber Orchestra on Claves is very heartfelt and intense, and though they are not perfectly together all the time, they make such a nice sound that it's hard to resist. They join the Dvorak with the Suk and Janacek equivalents, so you hear the development of the Czech string serenade.
Naxos also gives us the Suk serenade with the Dvorak; both are marvelous performances in gorgeous sound. The Editor is not alone in finding the Naxos the best available at any price. What a joy after Karajan!
...
The first performance did not cause much of a stir, but when Dvorak himself conducted it ten years later, the audience loved it. Then Hans Richter took it to London and reported to Dvorak that ``in the hundreds of concerts I have conducted, no novelty has had such a success''.
...
Dvorak wrote this in New York, but it was first performed in London. He got some advice from a cello professor in Prague; but that gentleman wanted a much more virtuoso piece, and Dvorak resisted many of his suggestions, writing something closer to a romantic epic. It is warm and lush and lets us enjoy the cello's richest tones.
...
In Alec Robertson's book on Dvorak, after calling the violin concerto warm-hearted, he says that the piano concerto has cold feet. Dvorak seemed afraid that the piano writing would not be effective, so like someone learning 10 cook he weighed out the ingredients fairly accurately but mixed them with a heavy hand.
Robertson calls the score ``a warning to young
composers''. He goes on to say that it is impossible for Dvorak to write for long without disarming us with a charming phrase, but in this concerto such phrases are immediately smothered in notes by the piano. 
``In the slow movement asphyxia almost sets in.'' 
To top it all off, it' s unpianistic. Robertson concludes that it will never take a place in the repertory---or even in the Dvorak canon. 
...
We like the Naxos recording by Jeno Jando, who is a really wonderful pianist---and is accompanied by a wonderful orchestra (coupled with the Editor's favorite performance of {\it The Water Goblin}). Justus Frantz recorded this three times-with Muller-Brühl, Bernstein, and Belohlavek---and one of them is always around. He is eminently suited to the music, and he makes I almost rhapsodic! There have also been three Richter recordings; the two available right now are in---concert ones. The one with Kleiber is not around right now;
...
The Cypresses was an early song cycle; Dvorak was in his 20s. The poems are "somewhat tearful and effeminate" (Hofmeister), but he always regarded the music with affection.
...
NOTE: Some Dvorak chamber pieces were covered in other overviews: 
