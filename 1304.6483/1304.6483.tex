...
%\be
%\rho_{\tilde{\pmb N} \pmb N,\tilde{\pmb N}{}' \pmb N'} = \sum_{l, \pmb M,  \tilde{\pmb M},  \pmb M',  \tilde{ \pmb M}{}'}
%U^{(l)}_{\tilde{\pmb N} \pmb N, \tilde{\pmb M} \pmb M}U^{(l)*}_{\tilde{\pmb N}{}' \pmb N', \tilde{\pmb M}{}' \pmb M'}  \psi^*_{\tilde{\pmb M} \pmb M l}  \psi^{\vphantom{*}}_{\tilde{\pmb M}{}'\pmb M'l} \,.  \label{dm1N}
%\ee
