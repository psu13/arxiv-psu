...
\textbf{irreps}---and for our limited purposes, \emph{particles are 
...
involved are complex.  For details, see the paper by Bertolini \emph{et al}
...
treatments by Pais~\cite{pais:ib} and Hoddeson \emph{et al}~\cite{hoddeson}. 
...
code indicating the presence or absence of \emph{up, down, red,
green} and \emph{blue}.
