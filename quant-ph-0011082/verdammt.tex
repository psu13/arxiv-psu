...
\medskip
\begin{center} A WATCHED POT NEVER BOILS \end{center}
\smallskip
...
\medskip
\begin{center} WATCHED POTS IN THE LABORATORY\footnote{For a good recent
review see \cite{Whitaker:PQE}.} \end{center}
\smallskip
The conclusion of the above theorem has come to be known as the quantum 
Zeno paradox --- an unfortunate name, since Zeno's paradox of the arrow 
...
\medskip
\begin{center} WATCHED POTS IN THE STUDY \end{center}
\smallskip
...
\medskip
\begin{center} NECESSARY TRANSITION PROBABILITIES \end{center}
\smallskip
...
\medskip
\begin{center} POSSIBLE TRANSITION PROBABILITIES \end{center}
\smallskip
...
\medskip
\begin{center}APPLICATION TO DECAY PROCESSES\end{center}
\smallskip
...
\medskip
\begin{center}CHOICES, CHOICES\ldots \end{center}
\smallskip
...
\medskip
\begin{center}\ldots AND HOW TO LIVE WITH THEM\end{center}
\smallskip
...
\medskip
\begin{center}INTERNAL AND EXTERNAL\end{center}
\smallskip
...
\medskip
\begin{center}
  IS YOUR POSTULATE REALLY NECESSARY?
\end{center}
\smallskip
